...
:type: prop
:tags: line
:dependencies: I.11, I.def.10




.. picture:: I.13.graphic.inverted.png
...
Now, if the angle ``CBA`` is equal to the angle ``ABD``, they are two right angles. [:ref:`I.def.10 <I.def.10>`]

But, if not, let ``BE`` be drawn from the point ``B`` at right angles to ``CD``; [:ref:`I.11 <I.11>`] therefore the angles ``CBE``, ``EBD`` are two right angles.
...
.. graphviz::
   ...
   digraph {
     ...
     "I.13" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/I/13/", target="_top"];
