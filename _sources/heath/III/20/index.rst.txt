...
.. picture:: III.20.graphic.inverted.png
...
.. container:: center
   ...
   the angle ``EAB`` is also equal to the angle ``EBA``; [:ref:`I.5 <I.5>`]


therefore the angles ``EAB``, ``EBA`` are double of the angle ``EAB``.

But the angle ``BEF`` is equal to the angles ``EAB``, ``EBA``; [:ref:`I.32 <I.32>`] therefore the angle ``BEF`` is also double of the angle ``EAB``.
...
.. graphviz::
   ...
   digraph {
     ...
     "III.20" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/III/20/", target="_top"];
