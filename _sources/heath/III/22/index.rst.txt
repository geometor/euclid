...
.. picture:: III.22.graphic.inverted.png
...
Then, since in any triangle the three angles are equal to two right angles, [:ref:`I.32 <I.32>`]
...
But the angle ``CAB`` is equal to the angle ``BDC``, for they are in the same segment ``BADC``; [:ref:`III.21 <III.21>`] and the angle ``ACB`` is equal to the angle
...
.. graphviz::
   ...
   digraph {
     ...
     "III.22" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/III/22/", target="_top"];
