...
:type: prop
:tags: line, circle
:dependencies: I.4, III.27




.. picture:: III.29.graphic.inverted.png
...
.. container:: center
   ...
   the angle ``BKC`` is also equal to the angle ``ELF``. [:ref:`III.27 <III.27>`]
...
.. container:: center
   ...
   the radii are also equal; therefore the two sides ``BK``, ``KC`` are equal to the two sides ``EL``, ``LF``; and they contain equal angles; therefore the base ``BC`` is equal to the base ``EF``. [:ref:`I.4 <I.4>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "III.29" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/III/29/", target="_top"];
