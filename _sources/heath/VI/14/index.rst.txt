...
.. picture:: VI.14.graphic.inverted.png
...
.. container:: center
   ...
   therefore ``FB``, ``BG`` are also in a straight line. [:ref:`I.14 <I.14>`]
...
therefore, as ``AB`` is to ``FE``, so is ``BC`` to ``FE``. [:ref:`V.7 <V.7>`]

But, as ``AB`` is to ``FE``, so is ``DB`` to ``BE``, [:ref:`VI.1 <VI.1>`] and, as ``BC`` is to ``FE``, so is ``GB`` to ``BF``. [``id``.] therefore also, as ``DB`` is to ``BE``, so is ``GB`` to ``BF``. [:ref:`V.11 <V.11>`]
...
For since, as ``DB`` is to ``BE``, so is ``GB`` to ``BF``, while, as ``DB`` is to ``BE``, so is the parallelogram ``AB`` to the parallelogram ``FE``, [:ref:`VI.1 <VI.1>`] and, as ``GB`` is to ``BF``, so is the parallelogram ``BC`` to the parallelogram ``FE``, [:ref:`VI.1 <VI.1>`] therefore also, as ``AB`` is to ``FE``, so is ``BC`` to ``FE``; [:ref:`V.11 <V.11>`] therefore the parallelogram ``AB`` is equal to the parallelogram ``BC``. [:ref:`V.9 <V.9>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VI.14" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VI/14/", target="_top"];
...
:ref:`VI.16`, :ref:`VI.17`, :ref:`VI.30`, :ref:`X.100`, :ref:`X.101`, :ref:`X.102`, :ref:`X.104`, :ref:`X.106`, :ref:`X.107`, :ref:`X.108`, :ref:`X.109`, :ref:`X.110`, :ref:`X.111`, :ref:`X.112`, :ref:`X.113`, :ref:`X.114`, :ref:`X.22`, :ref:`X.23`, :ref:`X.25`, :ref:`X.26`, :ref:`X.27`, :ref:`X.28`, :ref:`X.31`, :ref:`X.32`, :ref:`X.34`, :ref:`X.35`, :ref:`X.38`, :ref:`X.40`, :ref:`X.41`, :ref:`X.42`, :ref:`X.43`, :ref:`X.44`, :ref:`X.45`, :ref:`X.46`, :ref:`X.47`, :ref:`X.54`, :ref:`X.56`, :ref:`X.58`, :ref:`X.59`, :ref:`X.60`, :ref:`X.61`, :ref:`X.62`, :ref:`X.63`, :ref:`X.64`, :ref:`X.65`, :ref:`X.67`, :ref:`X.69`, :ref:`X.70`, :ref:`X.71`, :ref:`X.72`, :ref:`X.75`, :ref:`X.77`, :ref:`X.78`, :ref:`X.79`, :ref:`X.80`, :ref:`X.81`, :ref:`X.82`, :ref:`X.83`, :ref:`X.84`, :ref:`X.91`, :ref:`X.92`, :ref:`X.93`, :ref:`X.94`, :ref:`X.95`, :ref:`X.96`, :ref:`X.97`, :ref:`X.98`, :ref:`X.99`, :ref:`XI.36`, :ref:`XIII.1`, :ref:`XIII.10`, :ref:`XIII.11`, :ref:`XIII.13`, :ref:`XIII.16`, :ref:`XIII.17`, :ref:`XIII.18`, :ref:`XIII.4`, :ref:`XIII.5`, :ref:`XIII.6`