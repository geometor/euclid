...
.. picture:: VII.15.graphic.inverted.png
...
Therefore also, as one of the antecedents is to one of the consequents, so will all the antecedents be to all the consequents; [:ref:`VII.12 <VII.12>`] therefore, as the unit BG is to the number EK, so is BC to EF.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.15" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/15/", target="_top"];
