...
.. picture:: VII.25.graphic.inverted.png
...
Therefore each of the two numbers D, A is prime to B; therefore the product of D, A will also be prime to B. [:ref:`VII.24 <VII.24>`]

But the number which is the product of D, A is C.

Therefore C, B are prime to one another. Q. E. D.
The Greek, ὁ ἐκ τοῦ ἑνὸς αὐτῶν γενόμενος, literally the number produced from the one of them,
leaves multiplied into itself
to be understood.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.25" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/25/", target="_top"];
