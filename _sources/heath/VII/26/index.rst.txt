...
.. picture:: VII.26.graphic.inverted.png
...
For, since each of the numbers A, B is prime to C, therefore the product of A, B will also be prime to C. [:ref:`VII.24 <VII.24>`]
...
Therefore the product of C, D will also be prime to E. [:ref:`VII.24 <VII.24>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.26" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/26/", target="_top"];
