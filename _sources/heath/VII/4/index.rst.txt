...
.. picture:: VII.4.graphic.inverted.png
...
But, if not, let the greatest common measure D of A, BC be taken; [:ref:`VII.2 <VII.2>`] and let BC be divided into the numbers equal to D, namely BE, EF, FC.
...
.. graphviz::
   ...
   digraph {
     ...
     rankdir="TB";
     "VII.4" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/4/", target="_top"];
