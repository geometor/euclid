...
.. picture:: X.106.graphic.inverted.png
...
For let BE be the annex to AB; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on AE, EB medial, but the rectangle contained by them rational. [:ref:`X.77 <X.77>`]
...
Therefore CD is a straight line which produces with a rational area a medial whole. [:ref:`X.77 <X.77>`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.106" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/106/", target="_top"];
