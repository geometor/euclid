...
.. picture:: X.107.graphic.inverted.png
...
For let BE be the annex to AB, and let the same construction be made; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on them medial, the rectangle contained by them medial, and further the sum of the squares on them incommensurable with the rectangle contained by them. [:ref:`X.78 <X.78>`]
...
Therefore CD is a straight line which produces with a medial area a medial whole. [:ref:`X.78 <X.78>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.107" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/107/", target="_top"];
