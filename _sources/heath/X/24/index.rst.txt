...
:type: prop
:tags: line
:dependencies: VI.1, X.11, X.23.p.1




.. picture:: X.24.graphic.inverted.png
...
And, since AB is commensurable in length with BC, while AB is equal to BD, therefore DB is also commensurable in length with BC; so that DA is also commensurable with AC. [:ref:`VI.1 <VI.1>`, :ref:`X.11 <X.11>`]

But DA is medial; therefore AC is also medial. [:ref:`X.23.p.1 <X.23.p.1>`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.24" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/24/", target="_top"];
