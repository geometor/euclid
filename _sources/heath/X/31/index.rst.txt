...
:type: prop
:tags: line
:dependencies: X.11, X.14, X.21, X.23, X.29, X.30
...
Let there be set out two rational straight lines A, B commensurable in square only and such that the square on A, being the greater, is greater than the square on B the less by the square on a straight line commensurable in length with A. [:ref:`X.29 <X.29>`]

And let the square on C be equal to the rectangle A, B.

Now the rectangle A, B is medial; [:ref:`X.21 <X.21>`] therefore the square on C is also medial; therefore C is also medial. [:ref:`X.21 <X.21>`]
...
But A is commensurable with B in square only; therefore C is also commensurable with D in square only. [:ref:`X.11 <X.11>`]

And C is medial; therefore D is also medial. [:ref:`X.23 <X.23>`, addition]

And since, as A is to B, so is C to D, and the square on A is greater than the square on B by the square on a straight line commensurable with A, therefore also the square on C is greater than the square on D by the square on a straight line commensurable with C. [:ref:`X.14 <X.14>`]
...
Similarly also it can be proved that the square on C exceeds the square on D by the square on a straight line incommensurable with C, when the square on A is greater than the square on B by the square on a straight line incommensurable with A. [:ref:`X.30 <X.30>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.31" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/31/", target="_top"];
...
:ref:`X.101`, :ref:`X.106`, :ref:`X.109`, :ref:`X.34`, :ref:`X.40`, :ref:`X.46`, :ref:`X.58`, :ref:`X.64`, :ref:`X.69`, :ref:`X.71`, :ref:`X.77`, :ref:`X.83`, :ref:`X.95`