...
:type: prop
:tags: line
:dependencies: X.26, X.39




.. picture:: X.45.graphic.inverted.png
...
Let AB be a major straight line divided at C, so that AC, CB are incommensurable in square and make the sum of the squares on AC, CB rational, but the rectangle AC, CB medial; [:ref:`X.39 <X.39>`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.45" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/45/", target="_top"];
