...
:type: prop
:tags: line
:dependencies: X.26, X.76




.. picture:: X.82.graphic.inverted.png
...
Let AB be the minor straight line, and let BC be an annex to AB;

therefore AC, CB are straight lines incommensurable in square which make the sum of the squares on them rational, but twice the rectangle contained by them medial. [:ref:`X.76 <X.76>`]

I say that no other straight line can be annexed to AB fulfilling the same conditions.

For, if possible, let BD be so annexed; therefore AD, DB are also straight lines incommensurable in square which fulfil the aforesaid conditions. [:ref:`X.76 <X.76>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.82" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/82/", target="_top"];
