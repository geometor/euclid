...
:type: prop
:tags: line
:dependencies: V.11, VI.2, XI.16




.. picture:: XI.17.graphic.inverted.png
...
Now, since the two parallel planes KL, MN are cut by the plane EBDO, their common sections EO, BD are parallel. [:ref:`XI.16 <XI.16>`]
...
And, since the straight line EO has been drawn parallel to BD, one of the sides of the triangle ABD, therefore, proportionally, as AE is to EB, so is AO to OD. [:ref:`VI.2 <VI.2>`]
...
But it was also proved that, as AO is to OD, so is AE to EB; therefore also, as AE is to EB, so is CF to FD. [:ref:`V.11 <V.11>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.17" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XI/17/", target="_top"];
...
:ref:`XII.10`, :ref:`XII.11`, :ref:`XII.12`, :ref:`XII.13`, :ref:`XII.14`, :ref:`XII.15`, :ref:`XII.4`, :ref:`XII.5`, :ref:`XII.6`, :ref:`XII.7`, :ref:`XII.8`