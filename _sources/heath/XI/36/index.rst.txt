...
:type: prop
:tags: line
:dependencies: VI.14, XI.31, XI.35




.. picture:: XI.36.graphic.inverted.png
...
Thus the sides about the equal angles NLM, DEF are reciprocally proportional; therefore the parallelogram MN is equal to the parallelogram DF. [:ref:`VI.14 <VI.14>`]

And, since the angles DEF, NLM are two plane rectilineal angles, and on them the elevated straight lines LO, EG are set up which are equal to one another and contain equal angles with the original straight lines respectively, therefore the perpendiculars drawn from the points G, O to the planes through NL, LM and DE, EF are equal to one another; [:ref:`XI.35 <XI.35>`, Por.] hence the solids LH, EK are of the same height.

But parallelepipedal solids on equal bases and of the same height are equal to one another; [:ref:`XI.31 <XI.31>`] therefore the solid HL is equal to the solid EK.
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.35" [fillcolor="#222244", URL="/heath/XI/35/", target="_top"];
     ...
     "XI.36" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XI/36/", target="_top"];
     ...
     "I.48" [fillcolor="#222244", URL="/heath/I/48/", target="_top"];
