...
.. picture:: XI.37.graphic.inverted.png
...
For, since the parallelepipedal solid KA is similar to LC, therefore KA has to LC the ratio triplicate of that which AB has to CD. [:ref:`XI.33 <XI.33>`]
...
For since, again, KA has to LC the ratio triplicate of that which AB has to CD, [:ref:`XI.33 <XI.33>`] and ME also has to NG the ratio triplicate of that which EF has to GH, [id.] and, as KA is to LC, so is ME to NG, therefore also, as AB is to CD, so is EF to GH.
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.37" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XI/37/", target="_top"];
