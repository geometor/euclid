...
:number: 17
:type: prop
:dependencies: I.26, I.33, I.47, III.27, III.31, V.12, VI.2, VI.8, VI.8.p.1, XI.11, XI.18, XI.2, XI.6, XI.7, XI.9, XI.def.14, XI.def.3, XI.def.4, XII.8.p.1




.. picture:: XII.17.graphic.inverted.png
...
Now, since OA is at right angles to the plane of the circle BCDE, therefore all the planes through OA are also at right angles to the plane of the circle BCDE; [:ref:`XI.18 <XI.18>`] hence the semicircles BOD, KON are also at right angles to the plane of the circle BCDE.
...
Let them be inscribed, and let them be BP, PQ, QR, RO and KS, ST, TU, UO, let SP, TQ, UR be joined, and from P, S let perpendiculars be drawn to the plane of the circle BCDE; [:ref:`XI.11 <XI.11>`] these will fall on BD, KN, the common sections of the planes, inasmuch as the planes of BOD, KON are also at right angles to the plane of the circle BCDE. [cf. :ref:`XI.def.4 <XI.def.4>`]

Let them so fall, and let them be PV, SW, and let WV be joined.

Now since, in the equal semicircles BOD, KON, equal straight lines BP, KS have been cut off, and the perpendiculars PV, SW have been drawn, therefore PV is equal to SW, and BV to KW. [:ref:`III.27 <III.27>`, :ref:`I.26 <I.26>`]

But the whole BA is also equal to the whole KA; therefore the remainder VA is also equal to the remainder WA; therefore, as BV is to VA, so is KW to WA; therefore WV is parallel to KB. [:ref:`VI.2 <VI.2>`]

And, since each of the straight lines PV, SW is at right angles to the plane of the circle BCDE, therefore PV is parallel to SW. [:ref:`XI.6 <XI.6>`]

But it was also proved equal to it; therefore WV, SP are also equal and parallel. [:ref:`I.33 <I.33>`]

And, since WV is parallel to SP, while WV is parallel to KB, therefore SP is also parallel to KB. [:ref:`XI.9 <XI.9>`]

And BP, KS join their extremities; therefore the quadrilateral KBPS is in one plane, inasmuch as, if two straight lines be parallel, and points be taken at random on each of them, the straight line joining the points is in the same plane with the parallels. [:ref:`XI.7 <XI.7>`]

For the same reason each of the quadrilaterals SPQT, TQRU is also in one plane.

But the triangle URO is also in one plane. [:ref:`XI.2 <XI.2>`]
...
Let AX be drawn from the point A perpendicular to the plane of the quadrilateral KBPS, and let it meet the plane at the point X; [:ref:`XI.11 <XI.11>`] let XB, XK be joined.

Then, since AX is at right angles to the plane of the quadrilateral KBPS, therefore it is also at right angles to all the straight lines which meet it and are in the plane of the quadrilateral. [:ref:`XI.def.3 <XI.def.3>`]
...
And the squares on AX, XB are equal to the square on AB, for the angle at X is right; [:ref:`I.47 <I.47>`] and the squares on AX, XK are equal to the square on AK. [id.]
...
And, if KD be joined, the rectangle DB, BZ is equal to the square on BK, and the rectangle DZ, ZB equal to the square on KZ; [:ref:`III.31 <III.31>`, :ref:`VI.8 <VI.8>` :ref:`VI.8.p.1 <VI.8.p.1>`] therefore the square on KB is less than double of the square on KZ.
...
And the squares on BX, XA are equal to the square on BA, and the squares on KZ, ZA equal to the square on KA; [:ref:`I.47 <I.47>`] therefore the squares on BX, XA are equal to the squares on KZ, ZA, and of these the square on KZ is greater than the square on BX; therefore the remainder, the square on ZA, is less than the square on XA.
