...
:type: prop
:tags: line
:dependencies: VI.1, VI.17, VI.def.3




.. picture:: XIII.1.graphic.inverted.png
...
Now, since AB has been cut in extreme and mean ratio at C, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`VI.def.3 <VI.def.3>`, :ref:`VI.17 <VI.17>`]
...
But, as KA is to AH, so is CK to CH; [:ref:`VI.1 <VI.1>`] therefore CK is double of CH.
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.1" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/1/", target="_top"];
...
:ref:`XIII.11`, :ref:`XIII.16`, :ref:`XIII.17`, :ref:`XIII.18`, :ref:`XIII.6`