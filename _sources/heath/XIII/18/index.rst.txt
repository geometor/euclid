...
:number: 18
:type: prop
:dependencies: IV.15.p.1, V.def.9, VI.20.p.1, VI.4, VI.8, XI.21, XIII.10, XIII.13, XIII.14, XIII.15, XIII.16, XIII.16.p.1, XIII.17, XIII.17.p.1, XIII.9




.. picture:: XIII.18.graphic.inverted.png
...
But, as BA is to AD, so is the square on BA to the square on AF, [:ref:`V.def.9 <V.def.9>`, :ref:`VI.8 <VI.8>`] for the triangle AFB is equiangular with the triangle AFD; therefore the square on BA is one and a half times the square on AF.

But the square on the diameter of the sphere is also one and a half times the square on the side of the pyramid. [:ref:`XIII.13 <XIII.13>`]
...
But, as AB is to BD, so is the square on AB to the square on BF; [:ref:`VI.8 <VI.8>`, :ref:`V.def.9 <V.def.9>`] therefore the square on AB is triple of the square on BF.

But the square on the diameter of the sphere is also triple of the square on the side of the cube. [:ref:`XIII.15 <XIII.15>`]
...
But the square on the diameter of the sphere is also double of the square on the side of the octahedron. [:ref:`XIII.14 <XIII.14>`]
...
But the square on the diameter of the sphere is also five times the square on the radius of the circle from which the icosahedron has been described. [:ref:`XIII.16.p.1 <XIII.16.p.1>`]

And AB is the diameter of the sphere; therefore KL is the radius of the circle from which the icosahedron has been described; therefore KL is a side of the hexagon in the said circle. [:ref:`IV.15.p.1 <IV.15.p.1>`]

And, since the diameter of the sphere is made up of the side of the hexagon and two of the sides of the decagon inscribed in the same circle, [:ref:`XIII.16.p.1 <XIII.16.p.1>`] and AB is the diameter of the sphere, while KL is a side of the hexagon, and AK is equal to LB, therefore each of the straight lines AK, LB is a side of the decagon inscribed in the circle from which the icosahedron has been described.

And, since LB belongs to a decagon, and ML to a hexagon, for ML is equal to KL, since it is also equal to HK, being the same distance from the centre, and each of the straight lines HK, KL is double of KC, therefore MB belongs to a pentagon. [:ref:`XIII.10 <XIII.10>`]

But the side of the pentagon is the side of the icosahedron; [:ref:`XIII.16 <XIII.16>`] therefore MB belongs to the icosahedron.

Now, since FB is a side of the cube, let it be cut in extreme and mean ratio at N, and let NB be the greater segment; therefore NB is a side of the dodecahedron. [:ref:`XIII.17.p.1 <XIII.17.p.1>`]
...
But the remaining two, I mean the side of the icosahedron and the side of the dodecahedron, are not in rational ratios either to one another or to the aforesaid sides; for they are irrational, the one being minor [:ref:`XIII.16 <XIII.16>`] and the other an apotome [:ref:`XIII.17 <XIII.17>`].

That the side MB of the icosahedron is greater than the side NB of the dodecahedron we can prove thus.

For, since the triangle FDB is equiangular with the triangle FAB, [:ref:`VI.8 <VI.8>`] proportionally, as DB is to BF, so is BF to BA. [:ref:`VI.4 <VI.4>`]

And, since the three straight lines are proportional, as the first is to the third, so is the square on the first to the square on the second; [:ref:`V.def.9 <V.def.9>`, :ref:`VI.20.p.1 <VI.20.p.1>`] therefore, as DB is to BA, so is the square on DB to the square on BF; therefore, inversely, as AB is to BD, so is the square on FB to the square on BD.
...
And, when AL is cut in extreme and mean ratio, KL is the greater segment, inasmuch as LK belongs to a hexagon, and KA to a decagon; [:ref:`XIII.9 <XIII.9>`] and, when FB is cut in extreme and mean ratio, NB is the greater segment; therefore KL is greater than NB.
...
And, since the angles at F are equal to four right angles and are equal, therefore one of them, as the angle AFB, is one right angle less a fifth; therefore the remaining angles FAB, ABF consist of one right angle and a fifth. 
