...
.. picture:: IX.14.graphic.inverted.png
...
But, if two numbers by multiplying one another make some number, and any prime number measure the product, it will also measure one of the original numbers; [:ref:`VII.30 <VII.30>`] therefore B, C, D will measure one of the numbers E, F.
