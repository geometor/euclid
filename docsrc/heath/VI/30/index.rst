...
:type: prop
:tags: line
:dependencies: VI.14, VI.29




.. picture:: VI.30.graphic.inverted.png
...
On ``AB`` let the square ``BC`` be described; and let there be applied to ``AC`` the parallelogram ``CD`` equal to ``BC`` and exceeding by the figure ``AD`` similar to ``BC``. [:ref:`VI.29 <VI.29>`]
...
But it is also equiangular with it; therefore in ``BF``, ``AD`` the sides about the equal angles are reciprocally proportional; [:ref:`VI.14 <VI.14>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VI.29" [fillcolor="#222244", URL="/heath/VI/29/", target="_top"];
     "VI.30" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VI/30/", target="_top"];
