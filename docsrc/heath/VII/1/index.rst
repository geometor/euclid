...
.. picture:: VII.1.graphic.inverted.png
...
Therefore no number will measure the numbers AB, CD; therefore AB, CD are prime to one another. [:ref:`VII.def.12 <VII.def.12>`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     rankdir="TB";
     "VII.1" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/1/", target="_top"];
