...
.. picture:: VII.16.graphic.inverted.png
...
Therefore, alternately, the unit E measures the number B the same number of times that A measures C. [:ref:`VII.15 <VII.15>`]
...
The Greek has οἰ γενόμενοι ἐξ αὐτῶν, the (numbers) produced from them.
By from them
Euclid means from the original numbers,
though this is not very clear even in the Greek. I think ambiguity is best avoided by leaving out the words.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.16" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/16/", target="_top"];
