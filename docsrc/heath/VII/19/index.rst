...
:number: 290
:type: prop
:dependencies: V.7, V.9, VII.17, VII.18




.. picture:: VII.19.graphic.inverted.png
...
and let A by multiplying D make E, and let B by multiplying C make F; I say that E is equal to F.
...
Therefore, as C is to D, so is G to E. [:ref:`VII.17 <VII.17>`]
...
Therefore, as A is to B, so is G to F. [:ref:`VII.18 <VII.18>`]
...
.. container:: center
   ...
   therefore E is equal to F. [cf. :ref:`V.9 <V.9>`]


Again, let E be equal to F; I say that, as A is to B, so is C to D.

For, with the same construction, since E is equal to F, therefore, as G is to E, so is G to F. [cf. :ref:`V.7 <V.7>`]

But, as G is to E, so is C to D, [:ref:`VII.17 <VII.17>`]


.. container:: center

   and, as G is to F, so is A to B. [:ref:`VII.18 <VII.18>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.19" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/19/", target="_top"];
