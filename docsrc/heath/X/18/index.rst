...
:type: prop
:tags: line
:dependencies: X.13, X.16, X.16.l.1, X.6
...
Let A, BC be two unequal straight lines, of which BC is the greater, and to BC let there be applied a parallelogram equal to the fourth part of the square on the less, A, and deficient by a square figure. Let this be the rectangle BD, DC, [cf. :ref:`X.16.l.1 <X.16.l.1>`]

and let BD be incommensurable in length with DC; I say that the square on BC is greater than the square on A by the square on a straight line incommensurable with BC.
...
Since BD is incommensurable in length with DC, therefore BC is also incommensurable in length with CD. [:ref:`X.16 <X.16>`]

But DC is commensurable with the sum of BF, DC; [:ref:`X.6 <X.6>`] therefore BC is also incommensurable with the sum of BF, DC; [:ref:`X.13 <X.13>`] so that BC is also incommensurable in length with the remainder FD. [:ref:`X.16 <X.16>`]
...
But the square on BC is greater than the square on A by the square on a straight line incommensurable with BC; therefore BC is incommensurable in length with FD. so that BC is also incommensurable with the remainder, the sum of BF, DC. [:ref:`X.16 <X.16>`]

But the sum of BF, DC is commensurable in length with DC; [:ref:`X.6 <X.6>`] therefore BC is also incommensurable in length with DC, [:ref:`X.13 <X.13>`] so that, separando, BD is also incommensurable in length with DC. [:ref:`X.16 <X.16>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.18" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/18/", target="_top"];
...
:ref:`X.100`, :ref:`X.101`, :ref:`X.102`, :ref:`X.105`, :ref:`X.106`, :ref:`X.107`, :ref:`X.108`, :ref:`X.109`, :ref:`X.110`, :ref:`X.33`, :ref:`X.34`, :ref:`X.35`, :ref:`X.39`, :ref:`X.40`, :ref:`X.41`, :ref:`X.45`, :ref:`X.46`, :ref:`X.57`, :ref:`X.58`, :ref:`X.59`, :ref:`X.63`, :ref:`X.64`, :ref:`X.65`, :ref:`X.68`, :ref:`X.69`, :ref:`X.70`, :ref:`X.71`, :ref:`X.72`, :ref:`X.76`, :ref:`X.77`, :ref:`X.78`, :ref:`X.82`, :ref:`X.83`, :ref:`X.84`, :ref:`X.94`, :ref:`X.95`, :ref:`X.96`, :ref:`XIII.11`, :ref:`XIII.16`, :ref:`XIII.18`