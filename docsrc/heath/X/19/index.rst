...
.. picture:: X.19.graphic.inverted.png
...
And, as BD is to BC, so is DA to AC. [:ref:`VI.1 <VI.1>`]

Therefore DA is commensurable with AC. [:ref:`X.11 <X.11>`]

But DA is rational; therefore AC is also rational. [:ref:`X.def.4 <X.def.4>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.19" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/19/", target="_top"];
...
:ref:`X.108`, :ref:`X.109`, :ref:`X.25`, :ref:`X.54`, :ref:`X.55`, :ref:`X.57`, :ref:`X.58`, :ref:`X.71`, :ref:`X.91`, :ref:`X.92`, :ref:`X.94`, :ref:`X.95`, :ref:`XIII.11`, :ref:`XIII.16`, :ref:`XIII.18`