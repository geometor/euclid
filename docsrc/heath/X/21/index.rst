...
:type: prop
:tags: line
:dependencies: VI.1, X.11, X.def.4




.. picture:: X.21.graphic.inverted.png
...
For on AB let the square AD be described; therefore AD is rational. [:ref:`X.def.4 <X.def.4>`]
...
And, as DB is to BC, so is AD to AC; [:ref:`VI.1 <VI.1>`] therefore DA is incommensurable with AC. [:ref:`X.11 <X.11>`]

But DA is rational; therefore AC is irrational, so that the side of the square equal to AC is also irrational. [:ref:`X.def.4 <X.def.4>`]
...
Since then, as FE is to EG, so is FD to DG, [:ref:`VI.1 <VI.1>`] and FD is the square on FE, and DG the rectangle DE, EG, that is, the rectangle FE, EG, therefore, as FE is to EG, so is the square on FE to the rectangle FE, EG. 
...
.. graphviz::
   ...
   digraph {
     ...
     "X.21" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/21/", target="_top"];
...
:ref:`X.100`, :ref:`X.101`, :ref:`X.102`, :ref:`X.104`, :ref:`X.105`, :ref:`X.106`, :ref:`X.107`, :ref:`X.108`, :ref:`X.109`, :ref:`X.110`, :ref:`X.111`, :ref:`X.22`, :ref:`X.23`, :ref:`X.25`, :ref:`X.26`, :ref:`X.27`, :ref:`X.28`, :ref:`X.31`, :ref:`X.32`, :ref:`X.33`, :ref:`X.34`, :ref:`X.35`, :ref:`X.38`, :ref:`X.39`, :ref:`X.40`, :ref:`X.41`, :ref:`X.42`, :ref:`X.43`, :ref:`X.44`, :ref:`X.45`, :ref:`X.46`, :ref:`X.47`, :ref:`X.55`, :ref:`X.56`, :ref:`X.57`, :ref:`X.58`, :ref:`X.59`, :ref:`X.60`, :ref:`X.61`, :ref:`X.62`, :ref:`X.63`, :ref:`X.64`, :ref:`X.65`, :ref:`X.67`, :ref:`X.68`, :ref:`X.69`, :ref:`X.70`, :ref:`X.71`, :ref:`X.72`, :ref:`X.75`, :ref:`X.76`, :ref:`X.77`, :ref:`X.78`, :ref:`X.79`, :ref:`X.80`, :ref:`X.81`, :ref:`X.82`, :ref:`X.83`, :ref:`X.84`, :ref:`X.91`, :ref:`X.92`, :ref:`X.93`, :ref:`X.94`, :ref:`X.95`, :ref:`X.96`, :ref:`X.97`, :ref:`X.98`, :ref:`X.99`, :ref:`XIII.11`, :ref:`XIII.16`, :ref:`XIII.17`, :ref:`XIII.18`, :ref:`XIII.6`