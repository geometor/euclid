...
:type: prop
:tags: line
:dependencies: I.47, III.31, V.19.p.1, X.28.l.2, X.6.p.1, X.9




.. picture:: X.30.graphic.inverted.png
...
Let there be set out a rational straight line AB, and two square numbers CE, ED such that their sum CD is not square; [:ref:`X.28.l.2 <X.28.l.2>`]

let there be described on AB the semicircle AFB, let it be contrived that, as DC is to CE, so is the square on BA to the square on AF, [:ref:`X.6.p.1 <X.6.p.1>`] and let FB be joined.
...
But CD has not to DE the ratio which a square number has to a square number; therefore neither has the square on AB to the square on BF the ratio which a square number has to a square number; therefore AB is incommensurable in length with BF. [:ref:`X.9 <X.9>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.30" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/30/", target="_top"];
...
:ref:`X.100`, :ref:`X.101`, :ref:`X.102`, :ref:`X.105`, :ref:`X.106`, :ref:`X.107`, :ref:`X.108`, :ref:`X.109`, :ref:`X.110`, :ref:`X.31`, :ref:`X.32`, :ref:`X.33`, :ref:`X.34`, :ref:`X.35`, :ref:`X.39`, :ref:`X.40`, :ref:`X.41`, :ref:`X.45`, :ref:`X.46`, :ref:`X.57`, :ref:`X.58`, :ref:`X.59`, :ref:`X.63`, :ref:`X.64`, :ref:`X.65`, :ref:`X.68`, :ref:`X.69`, :ref:`X.70`, :ref:`X.71`, :ref:`X.72`, :ref:`X.76`, :ref:`X.77`, :ref:`X.78`, :ref:`X.82`, :ref:`X.83`, :ref:`X.84`, :ref:`X.94`, :ref:`X.95`, :ref:`X.96`, :ref:`XIII.11`, :ref:`XIII.16`, :ref:`XIII.18`