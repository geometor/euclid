...
:type: prop
:tags: line
:dependencies: X.16, X.23.p.1, X.33, X.6, X.def.4




.. picture:: X.39.graphic.inverted.png
...
For let two straight lines AB, BC incommensurable in square, and fulfilling the given conditions [:ref:`X.33 <X.33>`
], be added together; I say that AC is irrational.

For, since the rectangle AB, BC is medial, twice the rectangle AB, BC is also medial. [:ref:`X.6 <X.6>` :ref:`X.23.p.1 <X.23.p.1>`]

But the sum of the squares on AB, BC is rational; therefore twice the rectangle AB, BC is incommensurable with the sum of the squares on AB, BC, so that the squares on AB, BC together with twice the rectangle AB, BC that is, the square on AC, is also incommensurable with the sum of the squares on AB, BC; [:ref:`X.16 <X.16>`
] therefore the square on AC is irrational, so that AC is also irrational. [:ref:`X.def.4 <X.def.4>`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.39" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/39/", target="_top"];
...
:ref:`X.45`, :ref:`X.57`, :ref:`X.63`, :ref:`X.68`, :ref:`X.71`