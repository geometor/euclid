...
:number: 424
:type: prop
:dependencies: II.4, VI.1, X.11, X.22, X.36, X.42
...
And it is applied to the rational straight line EF; therefore HE is rational and incommensurable in length with EF. [:ref:`X.22 <X.22>`
]

For the same reason HN is also rational and incommensurable in length with EF.

And, since the sum of the squares on AC, CB is incommensurable with twice the rectangle AC, CB, therefore EG is also incommensurable with GN, so that EH is also incommensurable with HN. [:ref:`VI.1 <VI.1>`
, :ref:`X.11 <X.11>`
]

And they are rational; therefore EH, HN are rational straight lines commensurable in square only; therefore EN is a binomial straight line divided at H. [:ref:`X.36 <X.36>`
]

Similarly we can prove that it is also divided at M.

And EH is not the same with MN; therefore a binomial has been divided at different points: which is absurd. [:ref:`X.42 <X.42>`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.26" [fillcolor="#222244", URL="/heath/X/26/", target="_top"];
     ...
     "X.47" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/47/", target="_top"];
     ...
     "X.42" [fillcolor="#222244", URL="/heath/X/42/", target="_top"];
