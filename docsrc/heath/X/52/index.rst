...
:type: prop
:tags: line
:dependencies: V.19.p.1, X.36, X.6.p.1, X.9




.. picture:: X.52.graphic.inverted.png
...
Let it be contrived that, as CA is to AB, so is the square on EF to the square on FG. [:ref:`X.6.p.1 <X.6.p.1>`]
...
Therefore EF, FG are rational straight lines commensurable in square only; [:ref:`X.9 <X.9>`] therefore EG is binomial. [:ref:`X.36 <X.36>`]
...
Let then the squares on EF, H be equal to the square on GF; therefore, convertendo, as the number AB is to BC, so is the square on GF to the square on H. [:ref:`V.19.p.1 <V.19.p.1>`]
...
Therefore FG is incommensurable in length with H; [:ref:`X.9 <X.9>`] so that the square on FG is greater than the square on FE by the square on a straight line incommensurable with FG.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.52" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/52/", target="_top"];
