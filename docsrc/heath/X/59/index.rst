...
:type: prop
:tags: line
:dependencies: II.5, II.9, VI.1, X.11, X.13, X.21, X.41




.. picture:: X.59.graphic.inverted.png
...
For let the area ABCD be contained by the rational straight line AB and the sixth binomial AD, divided into its terms at E, so that AE is the greater term; I say that the side
of AC is the side of the sum of two medial areas.

Let the same construction be made as before shown.

It is then manifest that MO is the side
of AC, and that MN is incommensurable in square with NO.

Now, since EA is incommensurable in length with AB, therefore EA, AB are rational straight lines commensurable in square only; therefore AK, that is, the sum of the squares on MN, NO, is medial. [:ref:`X.21 <X.21>`]

Again, since ED is incommensurable in length with AB, therefore FE is also incommensurable with EK; [:ref:`X.13 <X.13>`] therefore FE, EK are rational straight lines commensurable in square only; therefore EL, that is, MR, that is, the rectangle MN, NO, is medial. [:ref:`X.21 <X.21>`]

And, since AE is incommensurable with EF, AK is also incommensurable with EL. [:ref:`VI.1 <VI.1>`, :ref:`X.11 <X.11>`]
...
Therefore MO is the side of the sum of two medial areas [:ref:`X.41 <X.41>`], and is the side
of AC. Q. E. D.
...
Since then a straight line has been cut into equal parts at D, and into unequal parts at C, therefore the rectangle AC, CB together with the square on CD is equal to the square on AD, [:ref:`II.5 <II.5>`] so that the rectangle AC, CB is less than double of the square on AD. 
But the squares on AC, CB are double of the squares on AD, DC; [:ref:`II.9 <II.9>`] therefore the squares on AC, CB are greater than twice the rectangle AC, CB. Q. E. D.]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.59" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/59/", target="_top"];
     ...
     "II.9" [fillcolor="#222244", URL="/heath/II/9/", target="_top"];
     ...
     "X.41" [fillcolor="#222244", URL="/heath/X/41/", target="_top"];
