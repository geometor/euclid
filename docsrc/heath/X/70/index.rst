...
.. picture:: X.70.graphic.inverted.png
...
For, since AB is the side of the sum of two medial areas,

let it be divided into its straight lines at E; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on them medial, the rectangle contained by them medial, and furthermore the sum of the squares on AE, EB incommensurable with the rectangle AE, EB. [:ref:`X.41 <X.41>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.70" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/70/", target="_top"];
