...
:number: 478
:type: prop
:dependencies: V.19.p.1, X.6, X.73, X.9, X.def.3.5




.. picture:: X.89.graphic.inverted.png
...
Since then, as the square on BG is to the square on GC, so is DE to EF, therefore, convertendo, as ED is to DF, so is the square on BG to the square on H. [:ref:`V.19.p.1 <V.19.p.1>`]

But ED has not to DF the ratio which a square number has to a square number; therefore neither has the square on BG to the square on H the ratio which a square number has to a square number; therefore BG is incommensurable in length with H. [:ref:`X.9 <X.9>`]
...
And the annex CG is commensurable in length with the rational straight line A set out; therefore BC is a fifth apotome. [:ref:`X.def.3.5 <X.def.3.5>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.89" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/X/89/", target="_top"];
