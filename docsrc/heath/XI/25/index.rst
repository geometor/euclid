...
:number: 53
:type: prop
:dependencies: V.def.5, XI.24




.. picture:: XI.25.graphic.inverted.png
...
Then, since the straight lines LK, KA, AE are equal to one another, the parallelograms LP, KV, AF are also equal to one another, KO, KB, AG are equal to one another, and further LX, KQ, AR are equal to one another, for they are opposite. [:ref:`XI.24 <XI.24>`]
...
Therefore, as the base AF is to the base FH, so is the solid AU to the solid UH. [:ref:`V.def.5 <V.def.5>`] Q. E. D.