...
:number: 566
:type: prop
:dependencies: V.7, V.9, VI.1, XI.25, XI.29, XI.30, XI.31, XI.32




.. picture:: XI.34.graphic.inverted.png
...
For parallelepipedal solids of the same height are to one another as the bases; [:ref:`XI.32 <XI.32>`] and, as the base EH is to NQ, so will CM be to AG, and it is manifest that in the parallelepipedal solids AB, CD the bases are reciprocally proportional to the heights.
...
Now, since the solid AB is equal to the solid CD, and CV is outside them, while equals have to the same the same ratio, [:ref:`V.7 <V.7>`] therefore, as the solid AB is to the solid CV, so is the solid CD to the solid CV.

But, as the solid AB is to the solid CV, so is the base EH to the base NQ, for the solids AB, CV are of equal height; [:ref:`XI.32 <XI.32>`] and, as the solid CD is to the solid CV, so is the base MQ to the base TQ [:ref:`XI.25 <XI.25>`] and CM to CT [:ref:`VI.1 <VI.1>`]; therefore also, as the base EH is to the base NQ, so is MC to CT.
...
But parallelepipedal solids on equal bases and of the same height are equal to one another; [:ref:`XI.31 <XI.31>`] therefore the solid AB is equal to the solid CD.
...
But, as the base EH is to the base NQ, so is the solid AB to the solid CV, for the solids AB, CV are of equal height; [:ref:`XI.32 <XI.32>`] and, as CM is to CT, so is the base MQ to the base QT [:ref:`VI.1 <VI.1>`] and the solid CD to the solid CV. [:ref:`XI.25 <XI.25>`]
...
Therefore the solid AB is equal to the solid CD. [:ref:`V.9 <V.9>`]
...
Since the solid AB is equal to the solid CD, while AB is equal to BT, for they are on the same base FK and of the same height; [:ref:`XI.29 <XI.29>` :ref:`XI.30 <XI.30>`] and the solid CD is equal to DX, for they are again on the same base RO and of the same height; [id.] therefore the solid BT is also equal to the solid DX.
...
But BT is equal to BA, for they are on the same base FK and of the same height; [:ref:`XI.29 <XI.29>` :ref:`XI.30 <XI.30>`] and the solid DX is equal to the solid DC. [id.]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.34" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XI/34/", target="_top"];
