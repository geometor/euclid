...
:number: 13
:type: prop
:dependencies: V.def.5, XII.11




.. picture:: XII.13.graphic.inverted.png
...
Then, since the axes LN, NE, EK are equal to one another, therefore the cylinders QR, RB, BG are to one another as their bases. [:ref:`XII.11 <XII.11>`]
...
Therefore, as the axis EK is to the axis KF, so is the cylinder BG to the cylinder GD. [:ref:`V.def.5 <V.def.5>`] Q. E. D.