...
:number: 586
:type: prop
:dependencies: V.11, V.7, V.9, XII.11, XII.13




.. picture:: XII.15.graphic.inverted.png
...
But cones and cylinders which are of the same height are to one another as their bases; [:ref:`XII.11 <XII.11>`] therefore the base ABCD is also equal to the base EFGH.
...
Now, since the cylinder AO is equal to the cylinder EP, therefore, as the cylinder AO is to the cylinder ES, so is the cylinder EP to the cylinder ES. [:ref:`V.7 <V.7>`]

But, as the cylinder AO is to the cylinder ES, so is the base ABCD to the base EFGH, for the cylinders AO, ES are of the same height; [:ref:`XII.11 <XII.11>`] and, as the cylinder EP is to the cylinder ES, so is the height MN to the height QN, for the cylinder EP has been cut by a plane which is parallel to its opposite planes. [:ref:`XII.13 <XII.13>`]

Therefore also, as the base ABCD is to the base EFGH, so is the height MN to the height QN. [:ref:`V.11 <V.11>`]
...
But, as the base ABCD is to the base EFGH, so is the cylinder AO to the cylinder ES, for they are of the same height; [:ref:`XII.11 <XII.11>`] and, as the height MN is to QN, so is the cylinder EP to the cylinder ES; [:ref:`XII.13 <XII.13>`] therefore, as the cylinder AO is to the cylinder ES, so is the cylinder EP to the cylinder ES. [:ref:`V.11 <V.11>`]

Therefore the cylinder AO is equal to the cylinder EP. [:ref:`V.9 <V.9>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XII.15" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XII/15/", target="_top"];
