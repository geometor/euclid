...
:type: prop
:tags: circle
:dependencies: I.26, I.32, I.4, I.5, II.2, III.26, IV.15.p.1, VI.17, VI.33, VI.4




.. picture:: XIII.10.graphic.inverted.png
...
And, since FA is equal to FB, and FH is perpendicular, therefore the angle AFK is also equal to the angle KFB. [:ref:`I.5 <I.5>`, :ref:`I.26 <I.26>`]

Hence the circumference AK is also equal to KB; [:ref:`III.26 <III.26>`] therefore the circumference AB is double of the circumference BK; therefore the straight line AK is a side of a decagon.
...
Therefore the whole circumference GB is also double of BM; hence the angle GFB is also double of the angle BFM. [:ref:`VI.33 <VI.33>`]
...
But the angle ABF is common to the two triangles ABF and BFN; therefore the remaining angle AFB is equal to the remaining angle BNF; [:ref:`I.32 <I.32>`] therefore the triangle ABF is equiangular with the triangle BFN.

Therefore, proportionally, as the straight line AB is to BF, so is FB to BN; [:ref:`VI.4 <VI.4>`] therefore the rectangle AB, BN is equal to the square on BF. [:ref:`VI.17 <VI.17>`]

Again, since AL is equal to LK, while LN is common and at right angles, therefore the base KN is equal to the base AN; [:ref:`I.4 <I.4>`] therefore the angle LKN is also equal to the angle LAN.
...
Therefore the remaining angle AKB is equal to the remaining angle KNA; [:ref:`I.32 <I.32>`] therefore the triangle KBA is equiangular with the triangle KNA.

Therefore, proportionally, as the straight line BA is to AK, so is KA to AN; [:ref:`VI.4 <VI.4>`] therefore the rectangle BA, AN is equal to the square on AK. [:ref:`VI.17 <VI.17>`]

But the rectangle AB, BN was also proved equal to the square on BF; therefore the rectangle AB, BN together with the rectangle BA, AN, that is, the square on BA [:ref:`II.2 <II.2>`], is equal to the square on BF together with the square on AK.

And BA is a side of the pentagon, BF of the hexagon [:ref:`IV.15.p.1 <IV.15.p.1>`], and AK of the decagon.
