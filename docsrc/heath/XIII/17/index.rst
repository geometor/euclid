...
:tags: line
:dependencies: I.47, I.8, V.15, VI.32, XI.1, XI.38, XI.6, XIII.15, XIII.4, XIII.5, XIII.6, XIII.7




.. picture:: XIII.17.graphic.inverted.png
...
Then, since the straight line NP has been cut in extreme and mean ratio at R, and RP is the greater segment, therefore the squares on PN, NR are triple of the square on RP. [:ref:`XIII.4 <XIII.4>`]

But PN is equal to NB, and PR to RU; therefore the squares on BN, NR are triple of the square on RU.

But the square on BR is equal to the squares on BN, NR; [:ref:`I.47 <I.47>`] therefore the square on BR is triple of the square on RU; hence the squares on BR, RU are quadruple of the square on RU.
...
And HP is parallel to TW, for each of them is at right angles to the plane BD; [:ref:`XI.6 <XI.6>`] and TH is parallel to PX, for each of them is at right angles to the plane BF. [id.]

But if two triangles, as XPH, HTW, which have two sides proportional to two sides be placed together at one angle so that their corresponding sides are also parallel, the remaining straight lines will be in a straight line; [:ref:`VI.32 <VI.32>`] therefore XH is in a straight line with HW.

But every straight line is in one plane; [:ref:`XI.1 <XI.1>`] therefore the pentagon UBWCV is in one plane.

I say next that it is also equiangular.

For, since the straight line NP has been cut in extreme and mean ratio at R, and PR is the greater segment, while PR is equal to PS, therefore NS has also been cut in extreme and mean ratio at P, and NP is the greater segment; [:ref:`XIII.5 <XIII.5>`] therefore the squares on NS, SP are triple of the square on NP. [:ref:`XIII.4 <XIII.4>`]
...
And, since the two sides BU, UV are equal to the two sides BW, WC, and the base BV is equal to the base BC, therefore the angle BUV is equal to the angle BWC. [:ref:`I.8 <I.8>`]
...
But if in an equilateral pentagon three angles are equal to one another, the pentagon will be equiangular, [:ref:`XIII.7 <XIII.7>`] therefore the pentagon BUVCW is equiangular.
...
For let XP be produced, and let the produced straight line be XZ; therefore PZ meets the diameter of the cube, and they bisect one another, for this has been proved in the last theorem but one of the eleventh book. [:ref:`XI.38 <XI.38>`]
...
Now, since the straight line NS has been cut in extreme and mean ratio at P, and NP is its greater segment, therefore the squares on NS, SP are triple of the square on NP. [:ref:`XIII.4 <XIII.4>`]
...
[Thus, since, as NP is to PR, so is PR to RN, the same is true of the doubles also, for parts have the same ratio as their equimultiples; [:ref:`V.15 <V.15>`] therefore as NO is to RS, so is RS to the sum of NR, SO.
...
Therefore UV, being a side of the dodecahedron, is an irrational apotome. [:ref:`XIII.6 <XIII.6>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.15" [fillcolor="#222244", URL="/heath/XIII/15/", target="_top"];
     ...
     "XI.38" [fillcolor="#222244", URL="/heath/XI/38/", target="_top"];
     ...
     "VI.32" [fillcolor="#222244", URL="/heath/VI/32/", target="_top"];
     ...
     "X.def.3.1" [fillcolor="#224422", URL="/heath/X/def.3.1/", target="_top"];
     ...
     "X.97" [fillcolor="#222244", URL="/heath/X/97/", target="_top"];
     ...
     "XIII.17" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/17/", target="_top"];
     ...
     "XIII.7" [fillcolor="#222244", URL="/heath/XIII/7/", target="_top"];
     ...
     "XIII.5" [fillcolor="#222244", URL="/heath/XIII/5/", target="_top"];
