...
:type: prop
:tags: line
:dependencies: V.14, VI.17, VI.def.3




.. picture:: XIII.5.graphic.inverted.png
...
Since AB has been cut in extreme and mean ratio at C, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`VI.def.3 <VI.def.3>` :ref:`VI.17 <VI.17>`, VI. 17]
...
Therefore, as DB is to BA, so is BA to AD. [:ref:`VI.17 <VI.17>`]

And DB is greater than BA; therefore BA is also greater than AD. [:ref:`V.14 <V.14>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.5" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/5/", target="_top"];
     "V.16" -> "V.15";
     "V.23" -> "V.15";
     "VI.1" -> "V.15";
     "XIII.5" -> "VI.def.3";
