...
:type: prop
:tags: line
:dependencies: I.32, I.4, I.5, I.6, III.28, IV.14, V.14, VI.33, VI.4




.. picture:: XIII.8.graphic.inverted.png
...
For let the circle ABCDE be circumscribed about the pentagon ABCDE. [:ref:`IV.14 <IV.14>`]

Then, since the two straight lines EA, AB are equal to the two AB, BC, and they contain equal angles, therefore the base BE is equal to the base AC, the triangle ABE is equal to the triangle ABC, and the remaining angles will be equal to the remaining angles respectively, namely those which the equal sides subtend. [:ref:`I.4 <I.4>`]

Therefore the angle BAC is equal to the angle ABE; therefore the angle AHE is double of the angle BAH. [:ref:`I.32 <I.32>`]

But the angle EAC is also double of the angle BAC, inasmuch as the circumference EDC is also double of the circumference CB; [:ref:`III.28 <III.28>`, :ref:`VI.33 <VI.33>`] therefore the angle HAE is equal to the angle AHE; hence the straight line HE is also equal to EA, that is, to AB. [:ref:`I.6 <I.6>`]

And, since the straight line BA is equal to AE, the angle ABE is also equal to the angle AEB. [:ref:`I.5 <I.5>`]

But the angle ABE was proved equal to the angle BAH; therefore the angle BEA is also equal to the angle BAH.

And the angle ABE is common to the two triangles ABE and ABH; therefore the remaining angle BAE is equal to the remaining angle AHB; [:ref:`I.32 <I.32>`] therefore the triangle ABE is equiangular with the triangle ABH; therefore, proportionally, as EB is to BA, so is AB to BH. [:ref:`VI.4 <VI.4>`]

But BA is equal to EH; therefore, as BE is to EH, so is EH to HB.

And BE is greater than EH; therefore EH is also greater than HB. [:ref:`V.14 <V.14>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.8" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/8/", target="_top"];
