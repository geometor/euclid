"""Module for organizing extracted files into a structured directory hierarchy."""
...
def get_max_page(pages: List[Dict[str, Any]]) -> int:
    """Returns the maximum page number from a list of page dictionaries."""
    if not pages:
        return 0
...
def assign_ranges(
    ...
    Args:
        ...
        parent_path: The parent path for the current entry.
        assignments: Dictionary mapping page_num -> path to be updated.
    """
...
def run_organization() -> None:
    """Organizes extracted content into folders based on page assignments."""
